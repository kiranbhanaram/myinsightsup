...
shell.app.execdblp.dashboard = ( function (my) {
    ...
    my._buildHeader = function () {
      ...
      // read the configuration for the header
      var headerConfig = getConfig();//@MobileDBUPFix
...
//@formatter:off
    ...
    s += "overflow: hidden;"
      ...
      + "text-overflow: ellipsis;"
      + "white-space: nowrap;"
      + "visibility: hidden;"//@MobileDBUPFix
      + "}"
...
//####src/execdblpig/readers/mobile/app.js
var shell = shell || {};
shell.app = shell.app || {};
shell.app.execdblp = shell.app.execdblp || {};
shell.app.execdblp.mobilereader = ( function (my) {
    ...
    my.handleDeviceReady = function () {
      ...
      function getData() {
        cordova.plugin.rsacertificate.decryptFile(
          function (fileContent) {
            if (!fileContent) {
              navigator.notification.alert(
                "Could not find a data file. Please use the 'Open in...' functionality on a data file (.jbi) from Secured Content Locker in order to provide data to this application.",
                null,
                'No Data',
                'OK'
              );
            ...
            // load dashboard based on provided data
            my.clearAppDisplay();
            var data = JSON.parse(fileContent);
            $("body").data("offline_data", data);
            shell.app.execdblp.mobilereader.build();
            $("#jbi_app_lp").show();
          }.bind(this),
          function (errorMessage) {
            navigator.notification.alert(
      ...
      window.plugins.touchid.isAvailable(
        ...
        function () {
          navigator.notification.alert(
            "This device does not have TouchId available which is required for this application.",
            null,
            'TouchId',
            'OK'
          );
    ...
    my.build = function (period, businessId) {
      var dashboard;
      var $body = $("body");

      setMobileChartSettings();
      addEventListeners();
      createMILaunchPadPeriods(period);
    
      $body.data('initialBusiness', businessId);

      function setMobileChartSettings() {
        Highcharts.setOptions({
          legend: {
            itemStyle: {
              font: '7pt Verdana'
      ...
      function addEventListeners() {
        ...
        $body.on("periodUpdate", function (evt, period) {
          ...
          // period in the report is stored as mmm.yyyy, but in the data it is stored as yyyy.mmm
          var periodSplit = period.split(".");
          var dataPeriod = periodSplit[1] + "." + periodSplit[0];
          getDashboard(dashboard, dataPeriod);

          shell.app.execdblp.openreport_mobile.activateAvailableReports(dataPeriod);
        });

        $body.unbind("openReport");
        $body.on("openReport", function (evt, params) {
          shell.app.execdblp.openreport_mobile.openReport(params);
        });
      }
       ...
       * JSON file.
       */
      function createMILaunchPadPeriods(selectedPeriod) {
        ...
        for (i = 0; i < periodIds.length; i++) {
          periods.push({
            id: periodIds[i],
            name: shell.app.execdblp.mobilereader.getPeriodName(periodIds[i])
          })
        }
        ...
        shell.app.execdblp.dashboard.buildSkeleton("jbi_app_lp", periods, selectedPeriod);


        // add the settings button
        //shell.app.execdblp.mobilereader.addSettingsButton();

        // add the glossary action
        shell.app.execdblp.mobilereader.addGlossary();
      ...
      function getDashboard(dashboard, period) {
        ...
        for (i = 0; i < offlineData.length; i++) {
          if (offlineData[i]["dashboard"] === dashboard && offlineData[i]["period"] === period.toString()) {
    ...
    return my;
  }(shell.app.execdblp.mobilereader || {})
);

//####src/execdblpig/readers/mobile/mod_addversion.js
shell.app.execdblp.mobilereader = ( function (my) {
...
//####src/execdblpig/readers/mobile/mod_getperiods.js
shell.app.execdblp.mobilereader = ( function (my) {
...
//####src/execdblpig/readers/mobile/mod_glossary.js
shell.app.execdblp.mobilereader = ( function (my) {
...
//####src/execdblpig/readers/mobile/mod_logo.js
shell.app.execdblp.mobilereader = ( function (my) {
...
//####src/execdblpig/readers/mobile/mod_messagedisplayer.js
shell.app.execdblp.mobilereader = ( function (my) {
...
//@formatter:off
    var s = "";
    s += "<div id='loadingContainer' style='padding:5px;position:fixed;top:50%;left:50%;margin:-70px 0 0 -170px;background-color:#EEEEEE;border-radius:5px;font-family: Verdana, Geneva, sans-serif;font-size: 10px;'>";
      ...
      s += "<div class=\"loadingText\" style='padding:16px;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;font-size:9px;line-height: 20px;'>" + message + "</div>";
    s += "</div>";
//@formatter:on
    $("body").append(s);
...
//####src/execdblpig/readers/mobile/mod_settings.js
shell.app.execdblp.mobilereader = ( function (my) {

  my.addSettingsButton = function () {
    _buildCSS();
    _addHTML();
    _addEventHandlers();

    function _addHTML() {
      var svg = '<svg style="width:20px;height:20px;padding-top:6px;" width="1792" height="1792" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M448 1472q0-26-19-45t-45-19-45 19-19 45 19 45 45 19 45-19 19-45zm644-420l-682 682q-37 37-90 37-52 0-91-37l-106-108q-38-36-38-90 0-53 38-91l681-681q39 98 114.5 173.5t173.5 114.5zm634-435q0 39-23 106-47 134-164.5 217.5t-258.5 83.5q-185 0-316.5-131.5t-131.5-316.5 131.5-316.5 316.5-131.5q58 0 121.5 16.5t107.5 46.5q16 11 16 28t-16 28l-293 169v224l193 107q5-3 79-48.5t135.5-81 70.5-35.5q15 0 23.5 10t8.5 25z"/></svg>';
      $("#jbi_header_reports").before("<div id='jbi_button_settings' style='float:right;' class='jbi_header_report active'>" + svg + "</div>");
    }
...
//@formatter:0ff
      var s = "";
      s += "<style type='text/css' id='CSS_SETTINGS' data-repstyle='execdblp'>";
      s += "#jbi_settings {";
      s += "  position: absolute;";
      s += "  top: 0;";
      s += "  bottom: 0;";
      ...
      s += "  z-index: 100;";
      s += "}";
      s += "#jbi_settings .jbi_header {";
      s += "  position: relative;";
      s += "  display: block;";
      s += "  height: 35px;";
      s += "}";
      s += "#jbi_settings .jbi_header_logo {";
      s += "  width: 50px;";
      s += "  height: 50px;";
      s += "  position: absolute;";
      s += "  top: 0px;";
      s += "  left: 4px;";
      s += "}";
      s += "#jbi_settings .jbi_header_title {";
      s += "  position: absolute;";
      s += "  display: inline-block;";
      s += "  line-height: 35px;";
      s += "  color: #dd1d21;";
      ...
      s += "  text-transform: uppercase;";
      s += "}";
      s += "#jbi_settings .jbi_header_subtitle {";
      s += "  position: absolute;";
      s += "  font-family: tahoma;";
      s += "  left: 70px;";
      s += "  top: 24px;";
...
//@formatter:on
    ...
    function _addEventHandlers() {
      var $settings = $("#jbi_button_settings");
      $settings.unbind(my.eventTrigger);
      $settings.on(my.eventTrigger, function () {
        my.showSettingsWindow();
      });
    }
  };


  my.showSettingsWindow = function () {
    _addHTML();
    _addEventHandlers();
...
//@formatter:0ff
      var svgClose = '<svg style="width:40px;height:40px;" width="1792" height="1792" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1225 1079l-146 146q-10 10-23 10t-23-10l-137-137-137 137q-10 10-23 10t-23-10l-146-146q-10-10-10-23t10-23l137-137-137-137q-10-10-10-23t10-23l146-146q10-10 23-10t23 10l137 137 137-137q10-10 23-10t23 10l146 146q10 10 10 23t-10 23l-137 137 137 137q10 10 10 23t-10 23zm215-183q0-148-73-273t-198-198-273-73-273 73-198 198-73 273 73 273 198 198 273 73 273-73 198-198 73-273zm224 0q0 209-103 385.5t-279.5 279.5-385.5 103-385.5-103-279.5-279.5-103-385.5 103-385.5 279.5-279.5 385.5-103 385.5 103 279.5 279.5 103 385.5z"/></svg>'
      var s = "";
      s += "<div id='jbi_settings'>";
        s += "<div class='jbi_header'>";
          s += '<img class="jbi_header_logo" src="' + my._getLogoBase64() + '">';
          s += '<div class="jbi_header_title">Settings</div>';
          s += '<div class="jbi_header_subtitle">Mobile Application</div>';
          s += '<div id="jbi_settings_close">' + svgClose + '</div>';
        s += "</div>";
        s += "<div class='jbi_setting_content'>";
          s += "<div class='jbi_setting_item' id='jbi_setting_changepassword'>Change Password</div>";
          s += "<div class='jbi_setting_item' id='jbi_setting_clearcache'>Delete Cached Data File</div>";
        s += "</div>";
      s += "</div>";
//@formatter:on
    ...
    function _addEventHandlers() {
      ...
      // Close the settings window
      var $jbi_settings_close = $("#jbi_settings_close");
      $jbi_settings_close.unbind(my.eventTrigger);
      $jbi_settings_close.on(my.eventTrigger, function () {
        var $jbi_settings = $("#jbi_settings");
        $jbi_settings.hide();
        $jbi_settings.remove();
      });

      // Change the application password
      var $jbi_settings_changepassword = $("#jbi_setting_changepassword");
      $jbi_settings_changepassword.unbind(my.eventTrigger);
      $jbi_settings_changepassword.on(my.eventTrigger, function () {
        cordova.plugin.authentication.changePassword(
          {
            appTitle: "MyInsight",
            appBackgroundColorHex: "FBCE07",
            appTextColorHex: "DD1D21",
            newLoginRequiredAfterMinutes: 0,
            passcodeOnly: false,
            maxLoginAttemps: 10,
            showWrongLoginAttempts: true,
            minutesUntilUnlock: 10,
            resetPasswordInsteadOfLock: true,
            passwordRenewelRequiredAfterDays: 50,
            passwordRequiresMimimalCharacters: 6,
            passwordRequiresSpecialCharacter: false,
            passwordRequiresNumericValue: false,
            passwordRequiresUppercaseCharacter: false,
            passwordRequiresLowercaseCharacter: false,
            passwordRequiresNotEqualToLastNo: 3,
            resetApplicationConfirmationMessage: "Are you sure you want to reset your password?."
          },
          function () {
            cordova.plugin.rsacertificate.showMessage({
                title: "Password Change",
                message: "Successfully changed your password!",
                backgroundColorHex: "FBCE07",
                textColorHex: "DD1D21"
              },
              function () {
                deferred.resolve();
      ...
      var $jbi_settings_clearcache = $("#jbi_setting_clearcache");
      $jbi_settings_clearcache.unbind(my.eventTrigger);
      $jbi_settings_clearcache.on(my.eventTrigger, function () {
        if (!my.hasCordova) {
          console.log("Cordova not available, nothing to do.");
        } else {
          var confirmMsg = "Are you sure you want to clear the cache?\n\nThis will delete the files containing the data which are stored inside the application. In order to use the application with new data, please use the 'Open in...' functionality from the Secured Content Locker again.";
...
//####src/execdblpig/readers/mobile/mod_utilities.js
shell.app.execdblp.mobilereader = ( function (my) {
...
//####src/execdblpig/openreport/mobile/app.js
var shell = shell || {};
shell.app = shell.app || {};
shell.app.execdblp = shell.app.execdblp || {};
shell.app.execdblp.openreport_mobile = (function (my) {
  ...
  my.activateAvailableReports = function (period) {
    ...
    for (i = 0; i < offlineData.length; i++) {
      if (offlineData[i].period === period.toString() &&
        (!offlineData[i]["isLaunchpad"] || offlineData[i]["isLaunchpad"] !== "X") &&
        (!offlineData[i]["hasError"] || offlineData[i]["hasError"] !== "X")) {
        availableReports.push({
          dashboard: offlineData[i]["dashboard"],
          version: offlineData[i]["version"],
          updateDate: offlineData[i]["updateDate"],
          updateTime: offlineData[i]["updateTime"]
        });
      }
    }

    // make the available reports active and show the information
    //@MobileDBUPFix - remove this code
    /*for (i = 0; i < availableReports.length; i++) {
      var reportDiv = $(".jbi_report[data-reportid='" + availableReports[i].dashboard + "']"),
        html = "";

      reportDiv.addClass("active");

      //@formatter:off
      html += "<div class='jbi_reports_details'>";
      html += "<table>";
      html += "<tr>";
      html += "<td>Version:</td>";
      html += "<td>" + availableReports[i].version + "</td>";
      html += "</tr>";
      html += "<tr>";
      html += "<td>Published:</td>";
      html += "<td>" + availableReports[i].updateDate + "</td>";
      html += "</tr>";
      html += "<tr>";
      html += "<td></td>";
      html += "<td>" + availableReports[i].updateTime + " UTC+1</td>";
      html += "</tr>";
      html += "</table>";
      html += "</div>";
      //@formatter:on
  ...
  my.openReport = function (params) {
    var $body = $("body"),
      offlineData = $body.data("offline_data").slice(0),
      //reportId = params.reportId,
      reportId = params.dashboardParams.dashboard, //@MobileDBUPFix
      periodObj = shell.app.execdblp.dashboard.period_functions.getCurrentPeriod(),
      period = periodObj.periodNumber + "." + periodObj.year,
      initialView = {}; //@MobileDBUPFix
    ...
    shell.app.execdb.mobilereader.build("jbi_app_report", reportId, period);
  };

  return my;
}(shell.app.execdblp.openreport_mobile || {}));
...
shell.app.execdb.dashboard = (function (my) {
  ...
  my._createGrid = function (containerDiv, config, dataId, businessData) {
    ...
    function createGrid(config, dataId, businessData) {
      ...
      //if (my.isMobile) {
        $grid.jqGrid('setFrozenColumns'); //@MobileDBUPFix
      //}
...
//####src/execdb/readers/mobile/app.js
var shell = shell || {};
shell.app = shell.app || {};
shell.app.execdb = shell.app.execdb || {};
shell.app.execdb.mobilereader = ( function (my) {

  my.build = function(elementId, dashboard, period) {
    var $body = $("body"),
    ...
    $body.on("dashboardLoaded", function () {
      shell.app.execdb.developerbuttons_mobile.buildDeveloperButtons();
    });


    // check if the mandatory parameters are provided
    if (!dashboard || !period) {
      my.showMessage("Error", "URL Parameters dashboard and/or period missing.");
    }
  ...
  return my;
}(shell.app.execdb.mobilereader || {}));

//####src/execdb/readers/mobile/mod_addversion.js
shell.app.execdb.mobilereader = ( function (my) {
...
//####src/execdb/readers/mobile/mod_messagedisplayer.js
shell.app.execdb.mobilereader = ( function (my) {
...
//####src/execdb/readers/mobile/mod_urlparams.js
shell.app.execdb.mobilereader = ( function (my) {
...
//####src/execdb/devbuttons/mobile/app.js
var shell = shell || {};
shell.app = shell.app || {};
shell.app.execdb = shell.app.execdb || {};
shell.app.execdb.developerbuttons_mobile = ( function (my) {
...
//@formatter:on
    ...
    function addEventHandlers() {
      ...
      function backToLaunchPad() {
        var $jbi_app_report = $("#jbi_app_report"),
          $body = $("body"),
          offlineData = $body.data("offline_data").slice(0),
          currentPeriod = shell.app.execdb.dashboard.period_functions.getCurrentPeriod(),
          currentPeriodId = currentPeriod.periodNumber + "." + currentPeriod.year;
        ...
        shell.app.execdblp.mobilereader.build(currentPeriodId, businessId);
        $("#jbi_app_lp").show();
      }
  ...
  return my;
}(shell.app.execdb.developerbuttons_mobile || {}));

//####src/execdb/devbuttons/mobile/mod_utilities.js
shell.app.execdb.developerbuttons_mobile = ( function (my) {
